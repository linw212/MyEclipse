...
function generateMenu(menuId, systemName) {
    if (menuId == "") {
        ...
        var url = path+"resources/frame/base/json/menu/menu_" + menuId + ".json";
        $.get(
            ...
            function (data) {
                ...
                $.each(data, function (i, e) {// 循环创建手风琴的项
                    ...
                    $.parser.parse();
                    $.get(path+"resources/frame/base/json/menu/menu_" + e.id + ".json", function (data) {// 循环创建树的项
                        $("#tree" + e.id).tree({
                            data: data,
                            lines: false,
                            animate: true,
                            onBeforeExpand: function (node, param) {
                                $("#tree" + e.id).tree('options').url = path+"resources/frame/base/json/menu/menu_" + node.id + ".json";
                            },
